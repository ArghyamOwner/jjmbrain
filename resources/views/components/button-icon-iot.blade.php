<a {{ $attributes }} href="{{ $href }}" class="w-8 h-8 rounded-lg hover:bg-gray-100 text-slate-400 hover:text-slate-500 flex items-center justify-center" x-data="{ tooltip: 'IOT' }" x-tooltip="tooltip" x-cloak>
