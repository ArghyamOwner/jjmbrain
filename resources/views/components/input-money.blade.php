...
<div class="{{ $noMargin ? 'mb-0' :  'mb-5' }}">	
    ...
    <div class="relative">
        ...
        <input
			...
			{{ $attributes->merge([
				'class' => 'form-input transition duration-150 ease-in-out pl-6 pr-3 py-2 block w-full text-gray-700 font-sans rounded-lg text-left focus:outline-none focus:border-indigo-500 focus:ring-indigo-500 shadow-sm border sm:text-sm placeholder-gray-400 ' . $errorClass . ' ' . $readonlyClass
			]) }}
