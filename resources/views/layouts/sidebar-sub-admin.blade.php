...
<x-sidebar>
	...
	<x-nav-item to="{{ route('principals') }}" class="flex items-center py-2 text-slate-200">
		<x-icon-user class="mr-4 text-slate-400 w-5 h-5" />Principals
	</x-nav-item>

	<x-nav-item to="{{ route('teachers') }}" class="flex items-center py-2 text-slate-200">
		<x-icon-user-check class="mr-4 text-slate-400 w-5 h-5" />Teachers
	</x-nav-item>
