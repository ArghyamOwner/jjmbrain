@auth
    <x-sidebar>
        ...
        <div class="text-slate-500 text-xs font-medium px-3 mt-5 mb-1 uppercase tracking-wider">IOT</div>
        <x-nav-item to="{{ route('schemes.users') }}" class="flex items-center py-2">
