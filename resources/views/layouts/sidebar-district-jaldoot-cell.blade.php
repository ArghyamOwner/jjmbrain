...
<x-sidebar>
	...
	<x-nav-item to="{{ route('jalshalas.create', ['type' => 'phase_I']) }}" class="flex items-center py-2">
	...
	<x-nav-item to="{{ route('jaladdas.create', ['type' => 'phase_I']) }}" class="flex items-center py-2">
		<x-icon-add class="mr-4 text-slate-400 w-5 h-5" />Add Jal Adda
	</x-nav-item>
	...
	<x-nav-item to="{{ route('jalshalas.create', ['type' => 'phase_II']) }}" class="flex items-center py-2">
		<x-icon-add class="mr-4 text-slate-400 w-5 h-5" />Add Jal Shala
	</x-nav-item>
	...
	<x-nav-item to="{{ route('jaladdas.create', ['type' => 'phase_II']) }}" class="flex items-center py-2">
		<x-icon-add class="mr-4 text-slate-400 w-5 h-5" />Add Jal Adda
	</x-nav-item>
