<x-app-layout title="Division Dashboard">
                            ...
                            <template x-for="item in searchResults">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <a :href="`/division-dashboard/${item.id}`"
                                            class="font-medium text-indigo-600 hover:text-indigo-700 hover:underline"
                                            x-text="item.name"></a>
                                    </td>
                                    <td x-text="item.total_schemes" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td x-text="item.ongoing_schemes" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td x-text="item.completed_schemes" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td x-text="item.handedover_schemes" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td x-text="item.jalmitra_assigned" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td x-text="item.yesterdays_bfm_stats" class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    </td>
                                    <td class="px-6 py-3 border-t border-gray-100 whitespace-nowrap">
                                    <x-button-icon-show href="`/division-dashboard/${item.id}`" />
                                    </td>
                                </tr>
                            </template>
