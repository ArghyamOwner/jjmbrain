<div>
    ...
    <x-slot name="secondaryTopbar">
        <x-navbar-top-transparent>
            ...
            {{-- <x-slot name="action">
                <x-button tag="a" href="{{ route('pages.create') }}" with-icon icon="add">New User</x-button>    
            </x-slot> --}}
        </x-navbar-top-transparent>
    </x-slot>
                ...
                <x-table.table>
                    <thead>
                        <tr>
                            ...
                            <x-table.thead>Slug</x-table.thead>
                    ...
                    <tbody>
                        @foreach($pages as $page)
                            <tr>
                                ...
                                <x-table.tdata>
                                    <x-link href="{{ route('tenant.pages.edit', $page['id']) }}">Edit</x-link>
                                </x-table.tdata>
                            </tr>
                        @endforeach
                    </tbody>
