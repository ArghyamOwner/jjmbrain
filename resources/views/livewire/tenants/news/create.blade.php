<div>
    ...
    <x-slot name="secondaryTopbar">
        <x-navbar-top-transparent>
            <x-slot:beforeTitle>
                <x-text-link with-back-icon href="{{ route('tenant.news') }}">Back to news</x-text-link>
            </x-slot>
            <x-slot:title>
                Create News
            </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-5 flex space-x-3 items-center">
                        ...
                        <x-button class="w-1/3" tag="a" href="{{ route('tenant.news') }}" color="white">Cancel</x-button>
                    </div>
                </div>
            </div>
        </form>
