<div>
    <x-slot name="title">Create Subtask</x-slot>
    ...
    <x-section-centered>
        <x-card overflow-hidden form-action="save">
            <x-card-form :with-shadow="false" no-padding>
                <x-slot name="title">Create a new subtask</x-slot>
                    ...
                    <x-input label="Title of subtask" name="subtask_name" wire:model.defer="subtask_name" />
