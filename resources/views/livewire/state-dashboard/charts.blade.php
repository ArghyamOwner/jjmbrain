        ...
        <x-card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6 mt-4">
                ...
                <div class="grid grid-cols-2 gap-2 mb-6 mt-4 p-6">
                    ...
                    <x-button class="bg-indigo-100 h-16 border-indigo-400 leading-none" color="white" tag="a"
                        href="{{ route('schemes', ['tpiProgress' => 'upto_90']) }}">
                        <div class="flex text-left space-x-3 -ml-16">
                            <div>
                                <span class="font-medium">{{ (int)$tpiData->where('key',
                                    'tpi_upto_90')->sum('value') ?? 'N/A' }}</span>
                                <div class="flex space-x-1 text-left leading-tight mt-1">
                    ...
                    <x-button class=" bg-yellow-100 h-16 border-yellow-300 grid-rows-2 leading-none" color="white"
                        tag="a" href="{{ route('schemes', ['tpiProgress' => 'upto_80']) }}">
                        <div class="flex text-left space-x-3 -ml-16">
                            <div>
                                <span class="font-medium">{{ (int)$tpiData->where('key',
                                    'tpi_upto_80')->sum('value') ?? 'N/A' }}</span>
                                <div class="flex space-x-1 text-left leading-tight mt-1">
                    ...
                    <x-button class=" bg-orange-100 h-16 border-orange-300 leading-none" color="white" tag="a"
                        href="{{ route('schemes', ['tpiProgress' => 'upto_50']) }}">
                        <div class="flex space-x-3 -ml-16">
                            <div>
                                <span class="font-medium">{{ (int)$tpiData->where('key',
                                    'tpi_upto_50')->sum('value') ?? 'N/A' }}</span>
                    ...
                    <x-button class=" bg-teal-100 h-16 border-teal-300 leading-none" color="white" tag="a"
                        href="{{ route('schemes', ['tpiProgress' => 'upto_30']) }}">
                        <div class="flex space-x-3 -ml-16">
                            <div>
                                <span class="font-medium">{{ (int)$tpiData->where('key',
                                    'tpi_upto_30')->sum('value') ?? 'N/A' }}</span>
                                <div class="flex space-x-1 leading-tight mt-1">
                    ...
                    <x-button class="bg-red-100 h-16 border-red-400 leading-none" color="white" tag="a"
                        href="{{ route('schemes', ['tpiProgress' => 'no']) }}">
                        <div class="flex space-x-3 -ml-16">
                            <div>
                                <span class="font-medium">{{ (int)$tpiData->where('key',
                                    'without_tpi_progress')->sum('value') ?? 'N/A' }}</span>
                                <div class="flex space-x-1 leading-tight mt-1">
