<div>
    <x-slot name="title">Edit Contractor</x-slot>
    ...
    <x-section-centered>
        <x-card overflow-hidden form-action="save" card-classes="mb-8">
        ...
        <livewire:contractor-documents.create :contractor-id="$contractorId" />
