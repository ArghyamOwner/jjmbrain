<div>
    <x-slot name="title">Update Pre Jal Shala Data</x-slot>
    ...
    <x-section-centered>
        <x-card form-action="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <x-input type="datetime-local" label="Day 2" name="dayTwo" wire:model.defer="dayTwo" />
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <x-select optional label="Trainer 2" name="trainerTwo" wire:model="trainerTwo" hint="Select trainer 2 if required">
                    <option value="">--Select a trainer--</option>
                    @foreach ($this->trainers as $trainerValue => $trainerLabel)
                        <option value="{{ $trainerValue }}">{{ $trainerLabel }}</option>
                    @endforeach
