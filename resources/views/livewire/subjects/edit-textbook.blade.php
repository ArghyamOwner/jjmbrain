<div>
    <x-slideovers wire:model="show">
        <x-slot name="header">Edit Textbook Details</x-slot>
        ...
        <div class="py-4 px-5">
            <form wire:submit.prevent="save">
                ...
                <x-label for="image" class="mb-1">Book Image</x-label>
                @if ($imageUrl)
                    <div class="overflow-hidden h-32 w-24 bg-slate-50 mb-2">
                        <img src="{{ $imageUrl }}" alt="book-image" class="w-full h-32 object-fit">
                    </div>
                @endif
