...
class MenuEditSlideover extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'menulink.slug' => [
                'required',  
                Rule::unique('menulinks', 'slug')->where('tenant_id', session('tenant_id'))->ignore($this->menulink->id)
            ],
    ...
    {
        return Menulink::pluck('name', 'id')->all();
    }
    ...
    {
        return view('livewire.tenants.menulinks.menu-edit-slideover');
    }
}
